...
export const CLOUDINARY_CLOUD_NAME = "djrkvmpxe";
export const CLOUDINARY_UPLOAD_PRESET = "blog-dashboard";
export const CLOUDINARY_FOLDER = "blog-dashboard";
...
export const DIGITALOCEAN_FOLDER = "bayshore-communication";
